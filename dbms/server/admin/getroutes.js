...
{
    db.query('select s.seat_id,s.stadium_id,s.seat_type,s.seat_price, st.stadium_name, st.capacity, st.city, st.country from seats s, dbs.match m, stadium st where m.stadium_id = s.stadium_id and s.stadium_id = st.stadium_id and match_id=? and s.seat_id'+
